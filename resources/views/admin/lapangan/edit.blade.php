                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi"
                            id="exampleFormControlTextarea1" rows="4" placeholder="deskripsi...">{{ old('deskripsi', $lapangan->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select form-control @error('status') is-invalid @enderror" name="status"
                            ...
                            <option value="y" {{ old('status', $lapangan->status) == 'y' ? 'selected' : '' }}>Aktif
                            </option>
                            <option value="t" {{ old('status', $lapangan->status) == 't' ? 'selected' : '' }}>Tidak
                                Aktif</option>
                        </select>
                        @error('status')
                            <div class="invalid-feedback">
