                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block">
                                <img style="width: 100%; height: 410px; object-fit: cover"
                                    src="{{ asset('imgs/logo-1.jpg') }}" alt="login" class="img-fluid">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Futsal App 🏫</h1>
                                    </div>
                                    ...
                                    {{-- <span style="font-size: .9rem; font-style: italic; transform: translateY(10px)"
                                        class="text-primary text-center d-block">{{ setting('app_title') ?? config('app.name') }},
                                        {{ setting('app_email') ?? '@sekolahku' }}</span> --}}
                                </div>
                            </div>
                        </div>
                    </div>
